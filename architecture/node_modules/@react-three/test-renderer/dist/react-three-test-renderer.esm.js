...
import { extend, act as act$2, createRoot, _roots, reconciler } from '@react-three/fiber';
...
const act$1 = React.unstable_act;
...
const create = async (element, options) => {
  ...
  const _root = createRoot(canvas).configure({
    ...
    size: {
      width: (_options$width = options == null ? void 0 : options.width) != null ? _options$width : 1280,
      height: (_options$height = options == null ? void 0 : options.height) != null ? _options$height : 800,
      top: 0,
      left: 0,
...
export { index$1 as ReactThreeTest, act, create, index as default, waitFor };
